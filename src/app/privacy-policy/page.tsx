...
export const metadata: Metadata = {
  ...
  description:
    "RingSmart Privacy Policy. How we collect, use, and protect your information.",
};
  ...
  return (
    <div className="min-h-screen bg-background bg-grid relative overflow-hidden">
      ...
      <main className="relative z-10 mx-auto max-w-3xl px-6 py-20 text-center">
        ...
        <div className="mt-12 space-y-10 text-[15px] leading-relaxed text-foreground/90 text-left">
          <p>
            This Privacy Notice for Ringsmart (&lsquo;we&rsquo;,
            &lsquo;us&rsquo;, or &lsquo;our&rsquo;), describes how and why we
            might access, collect, store, use, and/or share
            (&lsquo;process&rsquo;) your personal information when you use our
            services (&lsquo;Services&rsquo;), including when you:
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 text-foreground/80">
            <li>
              ...
              <a
                href="https://ringsmart.tech"
                className="text-brand hover:text-brand-light transition-colors"
                target="_blank"
                rel="noopener noreferrer"
              >
                https://ringsmart.tech
              </a>{" "}
              or any website of ours that links to this Privacy Notice
            </li>
            <li>
              Download and use our mobile application (Ringsmart), or any other
              application of ours that links to this Privacy Notice
            </li>
            <li>
              Use Ringsmart. RingSmart is a mobile application that provides
              personalised boxing training plans. Users complete an assessment to
              receive a tailored training programme based on their skill level
              and goals. The app offers subscription-based access to training
              content and AI-powered training insights. RingSmart is available on
              iOS and Android.
            </li>
            <li>
          ...
          <section>
            ...
            <div className="space-y-4 text-foreground/80">
              ...
              <p>
                ...
                <a
                  href="https://app.termly.io/dsar/06613760-4ec9-416b-b387-77cf36b7543a"
                  className="text-brand hover:text-brand-light transition-colors"
                  target="_blank"
                  rel="noopener noreferrer"
                >
          ...
          <section>
            ...
            <ol className="list-decimal pl-6 space-y-1 text-brand">
              <li><a href="#infocollect" className="hover:text-brand-light transition-colors">WHAT INFORMATION DO WE COLLECT?</a></li>
              <li><a href="#infouse" className="hover:text-brand-light transition-colors">HOW DO WE PROCESS YOUR INFORMATION?</a></li>
              <li><a href="#legalbases" className="hover:text-brand-light transition-colors">WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</a></li>
              <li><a href="#whoshare" className="hover:text-brand-light transition-colors">WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</a></li>
              <li><a href="#cookies" className="hover:text-brand-light transition-colors">DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</a></li>
              <li><a href="#ai" className="hover:text-brand-light transition-colors">DO WE OFFER ARTIFICIAL INTELLIGENCE-BASED PRODUCTS?</a></li>
              <li><a href="#inforetain" className="hover:text-brand-light transition-colors">HOW LONG DO WE KEEP YOUR INFORMATION?</a></li>
              <li><a href="#infosafe" className="hover:text-brand-light transition-colors">HOW DO WE KEEP YOUR INFORMATION SAFE?</a></li>
              <li><a href="#privacyrights" className="hover:text-brand-light transition-colors">WHAT ARE YOUR PRIVACY RIGHTS?</a></li>
              <li><a href="#dnt" className="hover:text-brand-light transition-colors">CONTROLS FOR DO-NOT-TRACK FEATURES</a></li>
              <li><a href="#uslaws" className="hover:text-brand-light transition-colors">DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a></li>
              <li><a href="#policyupdates" className="hover:text-brand-light transition-colors">DO WE MAKE UPDATES TO THIS NOTICE?</a></li>
              <li><a href="#contact" className="hover:text-brand-light transition-colors">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a></li>
              <li><a href="#request" className="hover:text-brand-light transition-colors">HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</a></li>
            </ol>
          </section>
          ...
          <section id="infocollect">
            ...
            <p className="mb-4">
              ...
              <strong>Apple</strong> and <strong>Google</strong>. You may find
              their privacy notice links here:{" "}
              <a
          ...
          <section id="legalbases">
            ...
            <p className="font-semibold underline italic mb-3">
          ...
          <section id="cookies">
            ...
            <p className="mb-4">
              ...
              &lsquo;sale&rsquo;/&lsquo;sharing&rsquo; (which includes targeted
            ...
            <p>
              ...
              analyse the use of the Services. To opt out of being tracked by
          ...
          <section id="ai">
            ...
            <p className="mb-4">
              ...
              powered by artificial intelligence, machine learning, or similar
              technologies (collectively, &lsquo;AI Products&rsquo;). These
            ...
            <p className="mb-4">
              ...
              (&lsquo;AI Service Providers&rsquo;), including{" "}
              <strong>OpenAI</strong> and <strong>Anthropic</strong>. As outlined
              ...
              &rsquo;. You must not use the AI Products in any way that violates
          ...
          <section id="privacyrights">
            ...
            <ul className="list-disc pl-6 space-y-2 text-foreground/80 mb-4">
              ...
              <li>
                Navigate to Settings &rarr; Delete Account within the RingSmart
                app.
              </li>
            </ul>
            <p className="mb-4">
          ...
          <section id="dnt">
            ...
            <p className="mb-4">
              ...
              applications include a Do-Not-Track (&lsquo;DNT&rsquo;) feature or
          ...
          <section id="uslaws">
              ...
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="border border-white/10">
                    <th className="text-left p-3 border-r border-white/10 font-semibold">Category</th>
                    <th className="text-left p-3 border-r border-white/10 font-semibold">Examples</th>
                    <th className="text-left p-3 font-semibold">Collected</th>
                  </tr>
                </thead>
                <tbody className="text-foreground/70">
                  <tr className="border border-white/10">
                    <td className="p-3 border-r border-white/10">A. Identifiers</td>
                    <td className="p-3 border-r border-white/10">Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, Internet Protocol address, email address, and account name</td>
                    <td className="p-3">YES</td>
                  </tr>
                  <tr className="border border-white/10">
                    <td className="p-3 border-r border-white/10">B. Personal information as defined in the California Customer Records statute</td>
                    <td className="p-3 border-r border-white/10">Name, contact information, education, employment, employment history, and financial information</td>
                    <td className="p-3">YES</td>
                  </tr>
                  <tr className="border border-white/10">
                    <td className="p-3 border-r border-white/10">C. Protected classification characteristics</td>
                    <td className="p-3 border-r border-white/10">Gender, age, date of birth, race and ethnicity, national origin, marital status, and other demographic data</td>
                    <td className="p-3">NO</td>
                  </tr>
                  <tr className="border border-white/10">
                    <td className="p-3 border-r border-white/10">D. Commercial information</td>
                    <td className="p-3 border-r border-white/10">Transaction information, purchase history, financial details, and payment information</td>
                    <td className="p-3">NO</td>
                  </tr>
                  <tr className="border border-white/10">
                    <td className="p-3 border-r border-white/10">E. Biometric information</td>
                    <td className="p-3 border-r border-white/10">Fingerprints and voiceprints</td>
                    <td className="p-3">NO</td>
                  </tr>
                  <tr className="border border-white/10">
                    <td className="p-3 border-r border-white/10">F. Internet or other similar network activity</td>
                    <td className="p-3 border-r border-white/10">Browsing history, search history, online behaviour, interest data, and interactions with our and other websites, applications, systems, and advertisements</td>
                    <td className="p-3">NO</td>
                  </tr>
                  <tr className="border border-white/10">
                    <td className="p-3 border-r border-white/10">G. Geolocation data</td>
                    <td className="p-3 border-r border-white/10">Device location</td>
                    <td className="p-3">NO</td>
                  </tr>
                  <tr className="border border-white/10">
                    <td className="p-3 border-r border-white/10">H. Audio, electronic, sensory, or similar information</td>
                    <td className="p-3 border-r border-white/10">Images and audio, video or call recordings created in connection with our business activities</td>
                    <td className="p-3">NO</td>
                  </tr>
                  <tr className="border border-white/10">
                    <td className="p-3 border-r border-white/10">I. Professional or employment-related information</td>
                    <td className="p-3 border-r border-white/10">Business contact details in order to provide you our Services at a business level or job title, work history, and professional qualifications if you apply for a job with us</td>
                    <td className="p-3">NO</td>
                  </tr>
                  <tr className="border border-white/10">
                    <td className="p-3 border-r border-white/10">J. Education Information</td>
                    <td className="p-3 border-r border-white/10">Student records and directory information</td>
                    <td className="p-3">NO</td>
                  </tr>
                  <tr className="border border-white/10">
                    <td className="p-3 border-r border-white/10">K. Inferences drawn from collected personal information</td>
                    <td className="p-3 border-r border-white/10">Inferences drawn from any of the collected personal information listed above to create a profile or summary about, for example, an individual&rsquo;s preferences and characteristics</td>
                    <td className="p-3">NO</td>
                  </tr>
                  <tr className="border border-white/10">
                    <td className="p-3 border-r border-white/10">L. Sensitive personal information</td>
            ...
            <p className="mb-4">
              ...
              information in the section, &lsquo;
              <a
                href="#whoshare"
                className="text-brand hover:text-brand-light transition-colors"
              >
            ...
            <p className="mb-4">
              ...
              &lsquo;selling&rsquo; of your personal information.
            </p>
            <p className="mb-6">
            ...
            <h3 className="text-lg font-semibold mt-6 mb-3">
              California &lsquo;Shine The Light&rsquo; Law
            </h3>
            <p>
              California Civil Code Section 1798.83, also known as the &lsquo;Shine
              The Light&rsquo; law, permits our users who are California
              ...
              a request, please submit your request in writing to us by using the
              contact details provided in the section &lsquo;
              <a
                href="#contact"
                className="text-brand hover:text-brand-light transition-colors"
              >
          ...
          <section id="policyupdates">
            ...
            <p>
              ...
              version will be indicated by an updated &lsquo;Revised&rsquo; date
          ...
          <section id="contact">
            ...
            <div className="rounded-lg border border-white/10 bg-card px-5 py-4 inline-block text-sm">
              <p className="font-semibold">Ringsmart</p>
              <p>14 Hill Side</p>
              <p>Dudley, ENG DY3 2JT</p>
              <p>England</p>
            </div>
          </section>
